...
/**
  ...
  * @retval 0 in case of success, an error code otherwise
  */
int32_t net_if_get_ip_address(net_if_handle_t *pnetif_in, ipaddr_t *ip)
{
    int32_t ret;
    net_if_handle_t *pnetif;
...
/**
  ...
  * @retval 0 in case of success, an error code otherwise
  */
int32_t net_if_gethostbyname(net_if_handle_t *pnetif_in, sockaddr_t *addr, char_t *name)
{
...
/**
  ...
  * @retval 0 in case of success, an error code otherwise
  */
int32_t net_if_ping(net_if_handle_t *pnetif_in, sockaddr_t *addr, int32_t count, int32_t delay, int32_t response[])
{
    int32_t ret = NET_ERROR_FRAMEWORK;
    net_if_handle_t *pnetif;
...
/**
  ...
  * @retval 0 in case of success, an error code otherwise
  */
int32_t net_if_set_ipaddr(net_if_handle_t *pnetif_in, ipaddr_t ipaddr, ipaddr_t gateway, ipaddr_t netmask)
{
    int32_t ret = NET_ERROR_FRAMEWORK;
    net_if_handle_t *pnetif;
